            ...
            >
              ...
              <Box sx={{ display: 'flex', flexDirection: 'column', gap: 2.5 }}>
                <Box sx={{ display: 'flex', alignItems: 'center', gap: 2 }}>
                  <PersonIcon sx={{ color: '#0f6c7f' }} />
                  <Box>
                    <Typography variant="caption" display="block" sx={{ color: '#61717a', fontWeight: 500 }}>
                      Full Name
                    </Typography>
            ...
            <Box sx={{ display: 'flex', flexDirection: 'column', gap: 4 }}>
                ...
                <Grid item xs={12} sm={4}>
                  <Card
                    ...
                    sx={{
                      ...
                      border: '1px solid #dbe9ec',
                      bgcolor: '#e5f6f8',
                      boxShadow: '0 8px 24px rgba(15, 108, 127, 0.04)',
                    }}
                  >
                    <CardContent sx={{ display: 'flex', alignItems: 'center', gap: 2 }}>
                      <CalendarMonthIcon sx={{ fontSize: '2.5rem', color: '#0f6c7f' }} />
                      <Box>
                        <Typography variant="h5" sx={{ fontWeight: 800, color: '#0f6c7f' }}>
                          {appointments.length}
                        </Typography>
                        <Typography variant="caption" sx={{ color: '#45656a', fontWeight: 600 }}>
                          Total Bookings
                        </Typography>
                      </Box>
                    </CardContent>
              ...
              >
                <Box sx={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', mb: 3, flexWrap: 'wrap', gap: 2 }}>
                  <Typography variant="h6" sx={{ fontWeight: 700, color: '#0b4d5a' }}>
                    Your Appointments
                  </Typography>
                  <Button
                    component={Link}
                  ...
                  <Box sx={{ py: 6, textAlign: 'center' }}>
                    ...
                    <Button
                      ...
                      sx={{
                        ...
                        borderRadius: '12px',
                        textTransform: 'none',
                        '&:hover': { borderColor: '#0b4d5a', bgcolor: '#e5f6f8' },
                      }}
                    >
